...
namespace ft
{
	...
	class RBTree
	{
		...
		public:
			...
			{
				std::cout << "__start insert key" << std::endl; 
				Node<Key, T> *node = new Node<Key, T>(key);
				std::cout << "creat node" << std::endl; 
				insert(node);
